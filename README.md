...
## 📁 Project Structure
The core implementation and results are located in the [**ElectricityPricePrediction**](./ElectricityPricePrediction/) directory.

### Key Components:
- **`src/`**: Pipeline logic and model implementations (Naive, XGBoost, LSTM).
- **`data/`**: Integrated weather (8 stations), fuel prices (Oil, Coal, Gas), and 2019-2024 price data.
